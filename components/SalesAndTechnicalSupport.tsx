      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1  gap-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-4">
            Need help with setup, customization, or day-to-day use? Centridox Support is here for you — fast, responsive, and built right into your workspace.
          </p>
          <p className="text-sky-700 font-bold text-sm mb-2">Centridox B.V.</p>
          <p className="text-gray-500 text-sm mb-2">Lage Naarderweg 47</p>
          <p className="text-gray-500 text-sm mb-2">1217 GN Hilversum</p>
          <div className="flex items-center mb-2">
            ...
            <span className="text-sky-600 font-semibold">085 536 36 16</span>
          </div>
          <div className="flex items-center mb-2">
            <svg className="w-5 h-5 text-gray-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <a href="mailto:info@centridox.com" className="text-sky-600 hover:underline">info@centridox.com</a>
          </div>
          <p className="text-gray-500 text-sm mb-2">BTW: NL 8550 56 678 B01</p>
          <p className="text-gray-500 text-sm mb-2">Managing partner: P.R.I.M. (Peter) de Gruijter</p>
        </div>
